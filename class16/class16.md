Class 16: Pathway Analysis from RNA-Seq Data
================
Larissa Rapadas
2/27/2020
...
Nat Biotechnol 2013 Jan;31(1):46-53. PMID: 23222703 The authors report
on differential analysis of lung fibroblasts in response to loss of the
...
Looks like there is a `length` column in out countData that we need to
remove.
...
```
    ...
    ## Info: Working in directory /Users/larissarapadas/Desktop/BIMM143/bimm143_github/class16
